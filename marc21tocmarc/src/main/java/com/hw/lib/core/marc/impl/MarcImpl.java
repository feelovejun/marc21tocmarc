package com.hw.lib.core.marc.impl;
...
import com.hw.lib.core.marc.MarcComposer;
import com.hw.lib.core.marc.Subfield;
...
public class MarcImpl implements Marc {
	...
	protected void analyze() {
		try {	
			...
			throw new MarcException("解析MARC错误，源=" + strMarc, e);
		}
	}
	...
	private Marc rebuildMarc(List<Field> delList){
		...
		MarcComposer marcBuilder = new GbkMarcComposer(strHeader);
